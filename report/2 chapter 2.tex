...
This python file contains the main parameters to run the analysis. It is composed of differents classes: Paths, Filters, InterpadConfig, Subplots, PlotsConfig, and Colors. The following subsections will fivea brif word on these classes. 
...
This class is used to define the different thresholds to cut the noise and select the actual data. These values can be chosen by visualising them with the functions \texttt{plot$\_$amplitude()} and \texttt{plot$\_$amplitude$\_$against$\_$t$\_$peak()}. 